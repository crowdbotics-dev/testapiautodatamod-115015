...
## Project Structure
    ...
    ├── testapiautodatamod_115015  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115015`
...
2. Clone this repo and `cd testapiautodatamod_115015`
